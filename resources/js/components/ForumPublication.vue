                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="fenetre-publication">
                                <div class="fenetre-publication-header">
                                    ...
                                    <div>
                                        <p v-text="date(post.created_at)"></p>
                                    </div>
                                </div>
                                ...
                                <div class="fenetre-commentaire" v-for="(comment, index) in comments.slice().reverse()" v-bind:index="index">
                                    <div class="fenetre-commentaire-header">
                                        ...
                                        <div>
                                            <div class="d-flex">
                                                <div class="mr-auto">
                                                    <p v-text="date(comment.created_at)"></p>
                                                </div>
                                                <div v-if="admin === true" style="padding-left: 7px">
...
export default {
    ...
    mounted() {
        ...
        this.loadScrolling();
        this.loadOnePost(this.post_id);
        this.loadComments(this.post_id);
    },
    methods: {
        loadOnePost(id)
        {
            axios.post('/forum/loadonepost/' + id).then(response => {
        ...
        {
            axios.post('/forum/loadcomments/' + post_id).then(response => {
        ...
        addComment(post_id)
        {
            ...
            axios.post('/forum/addcomment', data).then(response => {
                console.log(response.data);
                this.publish = true;
        ...
        {
            this.errors = [];
            axios.post('/forum/deletecomment/' + id).then(response => {
                console.log(response.data);
